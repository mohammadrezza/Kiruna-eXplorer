...
// Middleware di validazione per l'aggiornamento di un documento
...
documentRouter.post("/", validateCreateDocument, createDocument);
...
documentRouter.put("/:documentId", validateUpdateDocument,updateDocument
  );
